...
var products = [
  {
    ...
    price: 89,
    sizes: ['S', 'M', 'L', 'XL'],
    description: 'Oversized fit. 100% heavyweight cotton fleece. Embossed sigil branding on chest. Raw-cut hem finish. Destroyed wash aesthetics. Drop shoulder construction.',
    images: [
  ...
  },
  {
    ...
    price: 145,
    sizes: ['S', 'M', 'L', 'XL'],
    description: 'Slim-fit technical shell. Reflective chrome coating. YKK metal zip details. Adjustable cuffs with snap closures. Interior mesh lining. Water-resistant.',
    images: [
  ...
  },
  {
    ...
    price: 110,
    sizes: ['S', 'M', 'L', 'XL'],
    description: 'Relaxed taper cut. Ripstop cotton blend. 6-pocket utility design. Reinforced knee panels. Adjustable ankle drawcord. Matte black hardware throughout.',
    images: [
  ...
  },
  {
    ...
    price: 65,
    sizes: ['S', 'M', 'L', 'XL'],
    description: 'Boxy oversized cut. 240gsm premium cotton. Puff-print skull graphic on back. Ribbed collar. Pre-shrunk garment dyed. Acid wash black finish.',
    images: [
